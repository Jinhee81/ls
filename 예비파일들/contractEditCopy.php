<!-- 레이아웃을 변경해서 다시 만들어봄, 또 변경할거라 예비폴더에 놔둠 -->
<?php
session_start();
...
include $_SERVER['DOCUMENT_ROOT']."/service/contract/contractEdit_condi.php";
 ?>

<script src="/js/etc/uploadfile.js?<?=date('YmdHis')?>"></script>
<link rel="stylesheet" href="/css/custom2.css">

<div class="container-fluid">
  <div class="row">
    <div class="col col-md-4"><!-- 왼쪽 섹션 시작 -->
      <div class=""><!-- 임대계약정보 파트 -->
        <?php include "contractEdit_ci.php";?>
      </div>
      <div class=""><!-- 임대계약 보증금 파트 -->
        <?php include "contractEdit_deposit.php";?>
      </div>
      <div class=""><!-- 임대계약 첨부파일 파트 -->
        <?php include "contractEdit_file.php";?>
      </div>
      <div class=""><!-- 임대계약 메모 파트 -->
        <?php include "contractEdit_memo.php";?>
      </div>
    </div><!-- 왼쪽 섹션 끝 -->

    <div class="col col-md-8"><!-- 오른쪽 섹션 시작-->
      <div class="">
        <?php
...
<div class="container-fluid"><!-- 하단 섹션 시작-->
