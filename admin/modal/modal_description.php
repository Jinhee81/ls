<div class="modal fade" id="smsDescription" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
              ...
              <div class="col">
                <textarea id='modaltextarea' class='form-control' style='background-color: #FAFAFA;width:160px;'>
                    ...
                    <div class='row mb-2'>
                        ...
                        <div class='col'>
                            <textarea id='modaltextarea' class='form-control' style='background-color: #FAFAFA;'
                                rows="8">
              </textarea>
                        </div>
                    </div>
                    <div class='row mb-2'>
                        ...
                        <div class='col col-md-8'><input class='form-control form-control-sm' id='mcustomer' disabled>
                        </div>
                    </div>
                    <div class='row mb-2'>
                        <div class='col col-md-4'>수신번호</div>
                        <div class='col col-md-8'><input class='form-control form-control-sm' id='recievenumber'
                                disabled></div>
                    </div>
                    <div class='row mb-2'>
                        <div class='col col-md-4'>발신번호</div>
                        <div class='col col-md-8'><input class='form-control form-control-sm' id='sentnumber' disabled>
                        </div>
                    </div>
                    <div class='row mb-2'>
