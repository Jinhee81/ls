        ...
        <div class="col">
          <div class="row">
            ...
            <div class="col-sm-3 pl-1">
              <a href="/svc/service/sms/smsSetting.php" target="_blank"><button class="btn btn-sm btn-block btn-dark" id="smsSettingBtn">상용구설정</button></a>
            </div>
          </div>
...
<script src="/svc/js/jquery-ui.min.js"></script>
<script src="/svc/js/datepicker-ko.js"></script>
<script src="/svc/js/jquery-ui-timepicker-addon.js"></script>
<script src="/svc/js/etc/newdate5.js?v=<%=System.currentTimeMillis()%"></script>
<script src="/svc/js/etc/sms_noneparase3.js?v=<%=System.currentTimeMillis()%>"></script>
<script src="/svc/js/etc/sms_existparase10.js?v=<%=System.currentTimeMillis()%>"></script>
<script src="/svc/js/etc/sms1.js?v=<%=System.currentTimeMillis()%>"></script>
<script>
...
$(document).ready(function(){
    ...
    $('.dateType').datepicker({
      ...
      // showOn: "button",
      buttonImage: "/svc/img/calendar.svg",
