...
$subIdx = $_GET['subIdx'];
$subIdx = substr($subIdx,1,strlen($subIdx)-2);

$array_chk = explode("||",$subIdx);
...
for($i=0; $i<sizeof($array_chk); $i++){
	...
	************************************/
	...
	//$Taxinvoice->addContactList[0]->email = $row_b['email'];			// 이메일주소
...
echo $_success_cnt . " / " . sizeof($array_chk) . "건이 발급되었습니다.";
?>