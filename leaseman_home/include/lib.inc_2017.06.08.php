...
function get_cnt_tbl_contract($types = ''){
	...
	*/
	...
	$sql_con_fun1		= "select count(*) as cnts from tbl_contract where c_idx = '".$_SESSION[customer][idx]."' " . $sub_tail;
...
function get_last_payment($goods_type = '' ){
	...
	*/
	...
	$sql_con_fun2		= "select * from tbl_payment where c_idx = '".$_SESSION[customer][idx]."' " . $sub_tail . " order by idx desc limit 0,1 ";
