...
<section class="container">
  <form method="post" action="contractCsv2_p.php">
    ...
    <table class="table table-bordered text-center">
      <tr>
        <td>순번</td>
        <td><span style='color:#F7BE81;'>* </span>buildingId</td>
        <td><span style='color:#F7BE81;'>* </span>groupId</td>
        <td><span style='color:#F7BE81;'>* </span>roomId</td>
        <td><span style='color:#F7BE81;'>* </span>customerId</td>
        <td>계약일자</td>
