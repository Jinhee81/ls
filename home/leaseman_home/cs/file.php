...
<? include('../inc/header.inc.php');?>		
	<section id="container" >	
		...
		<div class="wrap_1000">
			<div class="sub_tit">
				<h2><span class="stm_active">자료실</span></h2>
			</div>
			<div class="sc_top">
				...
				<table class="ta_list">
					...
					<tbody class="body_list">
						...
						<tr>
							...
							<td class="subject">
								<a href="file_view.php?mode=view&bbs_idx=<?=$row['bbs_idx']?><?=$secureLink?>&search_mode=<?=$search_mode?>&search_word=<?=$search_word?>&pg=<?=$pg?>" class="over_txt"><?=$row['subject']?></a>
							</td>
