...
tHead = "<table class='table table-bordered text-center'><tr><td style='width:6%'>순번</td><td style='width:34%'>"+starEx+"연락처</td><td style='width:34%'>"+starEx+"문의사항</td><td style='width:20%'>문의일자</td><td style='width:6%'></td></tr>";//문의고객제목
...
for (var i = 1; i < 11; i++) {
  ...
  tBody += "<td><input type='number' name='qDate"+i+"' class='form-control text-center' id='datepicker' onclick='pick();'></td>";//날짜
  tBody += "<td><button type='submit' class='btn btn-default'><i class='far fa-trash-alt'></i></button></td></tr>";//삭제버튼
}//문의고객내용

var case1 = tHead + tBody;

// ========================================================================

var indiHead, indiBody; //개인 변수

indiHead = "<tr><td style='width:6%'>순번</td><td style='width:20%'>"+starEx+"성명</td><td style='width:30%'>"+starEx+"연락처</td><td style='width:19%'>이메일</td><td style='width:19%'>특이사항</td><td style='width:6%'></td></tr>";
...
for (var i = 1; i < 11; i++){
  ...
  indiBody += "<td><input type='text' name='etc"+i+"' class='form-control text-center' maxlength='40'></td>";//특이사항
  indiBody += "<td><button type='submit' class='btn btn-default'><i class='far fa-trash-alt'></i></button></td></tr>";//삭제버튼
}

var case2 = indiHead + indiBody;
...
indiComHead=
  "<tr><td style='width:5%'>순번</td><td style='width:15%'>"+starEx+"성명</td><td style='width:15%'>사업자명</td><td style='width:25%'>"+starEx+"연락처</td><td style='width:25%'>사업자번호</td><td style='width:15%'>이메일</td><td style='width:5%'></td></tr>";
...
for (var i = 1; i < 11; i++){
  ...
  indiComBody +=
    "<td><input type='text' name='companyname"+i+"' class='form-control text-center' maxlength='14'></td>";
  indiComBody +=
    "<td><div class='form-row'><div class='form-group col mb-0'><input type='number' name='contact1"+i+"' class='form-control text-center' maxlength='3' oninput='maxlengthCheck(this);' required></div><div class='form-group col mb-0'><input type='number' name='contact2"+i+"' class='form-control text-center' maxlength='4' oninput='maxlengthCheck(this);' required></div><div class='form-group col mb-0'><input type='number' name='contact3"+i+"' class='form-control text-center' maxlength='4' oninput='maxlengthCheck(this);' required></div></div></td>";//연락처
  indiComBody +=
  ...
  indiComBody +=
    "<td><input type='email' name='email"+i+"' class='form-control text-center' maxlength='40'></td>";
  indiComBody +=
    "<td><button type='submit' class='btn btn-default'><i class='far fa-trash-alt'></i></button></td></tr>";
}

var case3 = indiComHead + indiComBody; //개인사업자 케이스

// ========================================================================

var corHead, corBody; //법인 변수

corHead="<tr><td style='width:5%'>순번</td><td style='width:8%'>구분</td><td style='width:20%'>"+starEx+"사업자명</td><td style='width:25%'>"+starEx+"연락처</td><td style='width:12%'>대표자명</td><td style='width:25%'>사업자번호</td><td style='width:5%'></td></tr>";

for (var i = 1; i < 11; i++){
  corBody += "<tr><td style='padding-top: 18px;'>"+i+"</td>";
  corBody += "<td><select name='div3"+i+"' class='form-control' onchange='div1Get();'><option value='주식회사' selected>(주)</option><option value='유한회사'>(유)</option><option value='합자회사'>(합)</option><option value='기타'>(기)</option></select></td>";
  corBody += "<td><input type='text' name='companyname"+i+"' class='form-control text-center' maxlength='14' required></td>";
  corBody += "<td><div class='form-row'><div class='form-group col mb-0'><input type='number' name='contact1"+i+"' class='form-control text-center' maxlength='3' oninput='maxlengthCheck(this);' required></div><div class='form-group col mb-0'><input type='number' name='contact2"+i+"' class='form-control text-center' maxlength='4' oninput='maxlengthCheck(this);' required></div><div class='form-group col mb-0'><input type='number' name='contact3"+i+"' class='form-control text-center' maxlength='4' oninput='maxlengthCheck(this);' required></div></div></td>";//연락처
  corBody += "<td><input type='text' name='name"+i+"' class='form-control text-center' maxlength='9'></td>";//대표자명
  corBody += "<td><div class='form-row'><div class='form-group col-md-4 mb-0'><input type='number' name='cNumber1"+i+"' class='form-control text-center' maxlength='3' oninput='maxlengthCheck(this);'></div><div class='form-group col-md-3 mb-0'><input type='number' name='cNumber2"+i+"' class='form-control text-center' maxlength='2' oninput='maxlengthCheck(this);'></div><div class='form-group col-md-5 mb-0'><input type='number' name='cNumber3"+i+"' class='form-control text-center' maxlength='5' oninput='maxlengthCheck(this);'></div></div></td>";
  corBody += "<td><button type='submit' class='btn btn-default'><i class='far fa-trash-alt'></i></button></td></tr>";//사업자번호
}

var case4 = corHead + corBody; //법인 케이스
