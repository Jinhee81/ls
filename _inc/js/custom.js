...
var Samar = function(){
	...
	var dzTheme = function(){
		 ...
		 if(screenWidth <= 991 ){
			console.log("991");
			jQuery('.navbar-nav > li > a').unbind().on('click', function(e){
				...
				console.log("chilren ", $subMenu.length);
				if(jQuery(this).next().html()){e.preventDefault();}
			...
			//jQuery('.navbar-nav > li > a').unbind().on('click', function(e){ e.preventDefault(); });
		}
		...
		jQuery('.menu-icon').on('click',function(){
            ...
            jQuery( '#navbarNavDropdown' ).removeClass( "collapse" );
			onePageLayout();
		});
		jQuery('.menu-close').on('click',function(){
            jQuery('.menu-close,.full-sidenav').removeClass('active');
            jQuery( '#navbarNavDropdown' ).addClass( "collapse" );
		});
		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.site-header .container > .logo-header .logo').attr('src','/tpl/hutechc/img/logo-4.png');
					$('.site-header .container > .logo-header .logo-2').attr('src','/tpl/hutechc/img/logo-4.png');
					$('.site-header .container > .logo-header .logo-3').attr('src','/tpl/hutechc/img/logo-4.png');
				} else {
					menu.removeClass('is-fixed');
					$('.site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3').attr('src','/tpl/hutechc/img/logo_white.png')
				}
			}
		});
