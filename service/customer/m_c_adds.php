...
<script src="csadds.js"></script>
<section class="container">
  <div class="jumbotron">
    <h1 class="display-4">일괄등록 화면입니다!</h1>
    <p class="lead">이 화면에서는 한꺼번에 많은 고객들을 등록하기에 좋아요~</p>
    <small>(1)<span id='star' style='color:#F7BE81;'>* </span>표시는 반드시 입력해야 합니다. (2)개수는 입력하고자하는 고객수를 입력하세요. 1~10 사이 숫자만 입력 가능합니다. (3)'생성하기'버튼을 누르면 입력할 수 있는 칸이 생성됩니다.</small>
    <hr class="my-4">
  </div>
</section>
