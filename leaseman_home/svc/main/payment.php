...
//  $sign = hash("sha256", $params);
 ...
 <form method="post" name="fm_pay" id="SendPayForm_id" class="" accept-charset="utf-8">
       ...
       <input type="hidden" name="closeUrl" value="https://www.leaseman.co.kr/svc/main/stdpay3/INIStdPaySample/close.php">
       <input type="hidden" name="popupUrl" value="https://www.leaseman.co.kr/svc/main/stdpay3/INIStdPaySample/popup.php">
...
$('.monthonly').on('click', function(){
    ...
    $.ajax({
        url     : "https://www.leaseman.co.kr/svc/main/stdpay3/INIStdPaySample/get_sign2.php",
