      ...
      <div class="modal-body">
        <div class="container">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-7 mb-1">
                    <input type="text" class="form-control form-control-sm text-center grey" id="mpExpectedDate2" value="<?=$edited_period[2]?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-5 mb-1">
                ...
                <div class="form-group col-md-7 mb-1">
                    <input type="text" class="form-control form-control-sm text-center grey" id="mexecutiveDate2" value="<?=$edited_period[2]?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-5 mb-1">
