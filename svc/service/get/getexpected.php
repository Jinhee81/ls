    ...
    success: function(data){
      ...
      if(datacount===0){
        ...
        $.each(data, function(key, value){
          ...
          returns += '<td class="text-right pr-3 mobile"><label class="mb-0">'+numberWithCommas(value.pAmount)+'</label><br>';
          returns += '<label class="mb-0">'+numberWithCommas(value.pvAmount)+'</label></td>';
          returns += '<td><a href="/svc/service/contract/contractEdit.php?page=schedule&id='+value.rid+'" name="ptamount" data-toggle="tooltip" data-placement="top" title="계약상세보기" class="green amountNumber">'+numberWithCommas(value.ptAmount)+'</a></td>';
