			...
			<div class="footer_tit">
				<div class="footer_site_link">
					<ul>
						...
						<li>
							<a href="https://www.leaseman.co.kr/svc/login.php" target="blank_" alt="뉴리스맨">뉴리스맨</a>
						</li>
						<!-- <li> -->
							<!--
				...
				<p class="adress">Copyright (c) 2016 bizffice. All Rights Reserved.<br>
새로운 리스맨을 사용해주세요. 상단 뉴리스맨을 클릭하세요 (데이터이전 지원합니다)
				</p>
			</div>
		</section><!--footer_end-->
