...
for ($i=1;$i<=6;$i++)
{
	...
	if ($mode == "reply") {
		...
		$sql = "INSERT INTO tbl_bbs_list (subject, simple, s_date, e_date, code, category, country_code, writer, notice_yn, secure_yn, contents, reply, hit, user_id, url, ufile1, rfile1, ufile2, rfile2, ufile3, rfile3, ufile4, rfile4, ufile5, rfile5, ufile6, rfile6, ip_address, b_ref, b_step, b_level, recomm_yn, r_date)
				VALUES ('$subject', '$simple', '$s_date', '$e_date', '$code', '$category',  '', '$writer', '$notice_yn', '$secure_yn', '$contents', '$reply', $hit, '$user_id', '$url', '$ufile_1', '$rfile_1', '$ufile_2', '$rfile_2', '$ufile_3', '$rfile_3', '$ufile_4', '$rfile_4', '$ufile_5', '$rfile_5', '$ufile_6', '$rfile_6',  '".$_SERVER["REMOTE_ADDR"]."', '$b_ref', 0, 0, '$recomm_yn', $r_date);";
