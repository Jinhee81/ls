    ...
    <table class="table table-hover text-center" id="checkboxTestTbl">
      ...
      <tbody>
        <tr>
          ...
          <td><?=$row['endDate']?></td>
          <td><?=$row['mAmount']?></td>
          <td class="mobile"><?=$row['mvAmount']?></td>
          <td class="mobile"><?=$row['mtAmount']?></td>
          <td>2029-01-01</td>
          <td class="mobile">계좌</td>
          <td class="mobile">1</td>
          <td class="mobile">0</td>
          <td class="mobile">0</td>
          <td class="mobile">입금대기</td>
