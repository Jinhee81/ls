  ...
  <div class="card-deck mt-3">
    <div class="card">
      ...
      <div class="card-header">
          <a href="../service/customer/customer.php"><h4 class="my-0 font-weight-normal">관계자</h4></a>
        </div>
      <div class="card-body">
    ...
    <div class="card">
      <!-- <img src="" class="card-img-top" alt="..."> -->
      <div class="card-header">
          <a href="../service/contract/contract.php"><h4 class="my-0 font-weight-normal">임대계약</h4></a>
        </div>
      <div class="card-body">
        <table class="table text-center table-bordered">
          <tr class="table-primary">
          ...
          for ($i=0; $i < count($buildingRow); $i++) {
            ...
            <tr>
              ...
              <td class="pink empty">
                <p class="mb-0" data-toggle="modal" data-target=".bd-example-modal-sm" name="공실"><u class="roomlist"><?=$buildingRow[$i][2][$j][5]?></u></p>
                <input type="hidden" name="list" value="<?=$buildingRow[$i][2][$j][7]?>">
              </td>
              <td class="charged">
                <p class="mb-0" data-toggle="modal" data-target=".bd-example-modal-sm" name="만실"><u class="roomlist"><?=$buildingRow[$i][2][$j][4]?></u></p>
