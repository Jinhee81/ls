    ...
    success: function(data){
      ...
      if(datacount===0){
        ...
        $.each(data, function(key, value){
          ...
          returns += '<td><button type="submit" name="edit" class="btn btn-default grey" data-toggle="modal" data-target="#editModal"><i class="far fa-edit"></i></button><button type="submit" name="delete" class="btn btn-default grey"><i class="far fa-trash-alt"></i></button></td>';
