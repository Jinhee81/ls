...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#0B173B;">
  <a class="navbar-brand" href="http://www.leaseman.co.kr/svc/main/main.php"><img src="http://www.leaseman.co.kr/svc/img/h1b.png" width="100" height="30" class="d-inline-block align-top" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/svc/service/contract/contract.php">방계약</a>
      </li>
      <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <span class="navbar-text" data-toggle="tooltip" data-placement="bottom" title="<?=$_SESSION['gradename']?>">
        <a href="/svc/user/myinfo.php">
        <i class="fas fa-user"></i>&nbsp;나의정보</a>
      </span>&nbsp;&nbsp;
      <span class="navbar-text">
      &nbsp;<?php if(isset($_SESSION['email'])) { 
        echo $_SESSION['email'].'님, 안녕하세요.';
         }
        ?>
      </span>&nbsp;&nbsp;
      <!-- <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"> -->
      <a class="btn btn-outline-success" href="/svc/user/logout.php" role="button">로그아웃</a>
    </form>
  </div>
</nav>