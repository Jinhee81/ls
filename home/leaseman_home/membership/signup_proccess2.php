...
if($result === false){
  ...
  $sms = array(
    array("입주자화면", "추석인사", "{입주자}님, 즐거운 추석 보내세요."),
    array("납부예정화면", "입금안내(부가세포함)", " 안녕하세요 ㅇㅇㅇ입니다. {예정일}까지 {시작일}~{종료일} {개월수}개월 이용료 {합계}원(부가세포함) 국민 123-123 예금주 ㅇㅇㅇ계좌로 입금하여주시기 바랍니다. 이용해주셔서 감사합니다. ㅇㅇㅇ드림"),
    array("납부예정화면", "연체안내", " 안녕하세요 ㅇㅇㅇ입니다. {입주자}님, 임대료가 연체되었습니다. 현재 연체일수는 {연체일수}일, 연체이자는 {연체이자}원입니다. 빠른 납부 요청드립니다. ㅇㅇㅇ드림"),
    array("납부완료화면", "세금계산서발행", "{입주자}님, 안녕하세요. {발행일}에 전자세금계산서 발행 완료하였으며 이메일 {이메일}로 발송하였습니다. 즐거운 하루 보내세요. ㅇㅇㅇ드림")
  );
