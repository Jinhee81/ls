...
$clist = array(
  'id' => htmlspecialchars($row_c['id']),
  'div2' => htmlspecialchars($row_c['div2']),
  'contact1' => htmlspecialchars($row_c['contact1']),
  'contact2' => htmlspecialchars($row_c['contact2']),
  'contact3' => htmlspecialchars($row_c['contact3']),
  'name' => htmlspecialchars($row_c['name']),
  'companyname' => htmlspecialchars($row_c['companyname']),
  'cNumber1' => htmlspecialchars($row_c['cNumber1']),
  'cNumber2' => htmlspecialchars($row_c['cNumber2']),
  'cNumber3' => htmlspecialchars($row_c['cNumber3'])
);
