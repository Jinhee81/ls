...
<a class="navbar-brand" href="https://www.leaseman.co.kr/svc/main/main.php"><img src="https://www.leaseman.co.kr/admin/img/h1b.png" width="100" height="30" class="d-inline-block align-top" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="https://www.leaseman.co.kr/svc/main/main.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
