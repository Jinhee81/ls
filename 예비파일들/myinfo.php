<!-- 이 파일이 여기온이유는 원래 담당자명이 있었는데 없애서 그거를 남기려고 여기 있음 -->
...
<div class="container" style="max-width:500px;">
  <form id="myinfo" method="post" action ="myinfo_edit_proccess.php" class="form-signin">
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" name="id" readonly class="form-control-plaintext" value="<?=$_SESSION['id']?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <select id="selectUserDiv" name="user_div" class="form-control">
            <option value='개인' <?php if($_SESSION['user_div']=="개인"){echo "selected";}?>> 개인</option>"
            <option value='사업자' <?php if($_SESSION['user_div']=="사업자"){echo "selected";}?>>사업자</option>"
          </select>
        </div>
