...
$sql = "SELECT good_in_building.id, good_in_building.name as gName, building.name as bName, building.id as bId
  ...
  <form class="container" action="p_good_edit.php" method="post">
    ...
    <table class="table table-bordered text-center">
      <tr>
        ...
        <td scope="col col-md-8"><input class="form-control text-center" type="text" name="building_name" value="<?=$escaped_bName?>" disabled></td>
      </tr>
      <tr>
        <td scope="col col-md-4">기타상품</td>
        <td scope="col col-md-8"><input class="form-control text-center" type="text" name="good" required="" value="<?=$escaped_gName?>"></td>
      </tr>
    </table>
    <div class='mt-7'>
