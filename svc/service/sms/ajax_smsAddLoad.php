...
<script>
var newTr2 = "<td colspan='5' style='padding-left:20px;'><p class='grey'>*상용구항목<br>입주자화면 : {입주자},{이메일}<br>임대계약화면 : {입주자},{이메일},{계약일},{종료일}<br>납부예정화면 : {입주자},{이메일},{예정일},{합계},{시작일},{종료일},{개월수},{연체일수},{연체이자}<br>납부완료화면 : {입주자},{이메일},{입금일},{발행일},{공급가액},{세액},{합계}<br></p></td>";
