<?php
include $_SERVER['DOCUMENT_ROOT']."/main/lib.inc.php";
header("Content-Type: text/html; charset=utf-8");

        require_once('/main/INIStdPayUtil.php');
        require_once('/main/stdpay3/libs/HttpClient.php');
        require_once('/main/sha256.inc.php');
        require_once('/main/stdpay3/libs/json_lib.php');
