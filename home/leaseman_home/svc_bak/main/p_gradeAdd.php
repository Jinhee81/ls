...
if($_POST['paydiv']==='yearonly'){
  ...
  if(!$result2){
    ...
    */
    alertAndLocation('결제과정에 문제가 생겼습니다. 관리자에게 문의하세요.(1)', 'payment.php');
    ...
    //   //location.href = 'payment.php';
    //   </script>";
    alertAndLocation('결제과정에 문제가 생겼습니다. 관리자에게 문의하세요.(2)', 'payment.php');
      error_log(mysqli_error($conn));
    }
  }
}
...
if($_POST['paydiv']==='monthly') {
  ...
  if(!$result5){
    ...
    // </script>";
    alertAndLocation('결제과정에 문제가 생겼습니다. 관리자에게 문의하세요.(5)', 'payment.php');
    error_log(mysqli_error($conn));
  } else {
    $sql6 = "update user
             set
    ...
    //   //location.href = 'http://www.leaseman.co.kr/svc/main/payment.php';
    //   </script>";
    alertAndLocation('결제과정에 문제가 생겼습니다. 관리자에게 문의하세요.(6)', 'payment.php');
      error_log(mysqli_error($conn));
    } else {
...
// location.href = 'http://www.leaseman.co.kr/svc/main/main.php';
// </script>";
