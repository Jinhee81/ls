<!-- Modal1, 상용구없음, 개별적으로 문자보낼때 쓰는화면-->
<div class="modal fade" id="smsModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col col-md-6">
            <textarea rows="8" cols="80" class="form-control" style="background-color: #FAFAFA;" id="textareaOnly"></textarea>
            <div class="">
          ...
          <div class="col col-md-6">
            <table class="table table-sm text-center" style="color:#848484;">
              ...
              <tbody id="tbody">
                <tr>
                  <td>1</td>
                  <td><span id="mcname"></span>(<span id="recievephonenumber"></span>)
