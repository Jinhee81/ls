...
<ul class="w_gnb_wrap">
	...
	<li>
		<a href="../use_guide/fare_guide.php">이용료안내</a>
			<!-- <ul class="depth02_list two"> -->
				<!-- <li><a href="../use_guide/fare_guide.php">요금안내</a></li> -->
	...
	<li>
		<a href="../svc/login.php" target="_blank">체험하기</a>
	</li>
	<li>
		<a href="/_bbs/board_list.php?code=h_notice">공지사항</a>
