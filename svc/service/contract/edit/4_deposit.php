<div class="p-3 mb-2 text-dark border border-info rounded">
  ...
  <table class="table table-sm table-hover text-center mt-3">
    ...
    <tr>
      ...
      <td class="mobile">
        <input type="text" name="depositInAmount" class="form-control form-control-sm amountNumber text-center" numberOnly>
      </td>
      <td class="mobile">
        <input type="text" name="depositOutDate" class="form-control form-control-sm dateType text-center">
      </td>
      <td class="mobile">
        <input type="text" name="depositOutAmount" class="form-control form-control-sm amountNumber text-center" numberOnly>
      </td>
      <td class="">
        <input type="text" name="depositMoney" class="form-control form-control-sm amountNumber text-center" readonly numberOnly>
      </td>
