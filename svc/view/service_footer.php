    ...
    <footer class="text-center bg-light text-black pt-3">
      <div class="footer-1 pb-3">
        <a href="/about/company_introduction.php" target="_blank"><button class='btn btn-outline-warning btn-sm'>회사소개</button></a>&nbsp;&nbsp;
        ...
        <a href="/svc/question/question.php?div=errorwrite" target="_blank"><button class='btn btn-outline-danger btn-sm'>오류신고</button></a>&nbsp;&nbsp;
        <a href="/svc/question/question.php?div=dataModify" target="_blank"><button class='btn btn-outline-primary btn-sm'>데이터정정요청</button></a>&nbsp;&nbsp;
      </div>

      <div class="footer-above">
        <p class="mb-2">
          상호: 리스맨소프트 &nbsp;|&nbsp; 주소: 경기도 의정부시 동일로 119-1, 2층 &nbsp;|&nbsp; 대표: 유진희 &nbsp;|&nbsp;전화: 031-879-8003 &nbsp;|&nbsp;이메일: info@leaseman.co.kr
        </p>
        <p class="mb-2">
