...
<table class="table table-sm mt-2">
    ...
    <tfoot class="">
        ...
        <tr class="">
            ...
            <!-- <td class=""></td> -->
            <td>
                <input type="text" class="form-control form-control-sm text-right fontred numberComma" name=carPrice1
                    id=carPrice1>
            </td>
        </tr>
        <tr class="">
            ...
            <!-- <td class=""></td> -->
            <td>
                <input type="text" class="form-control form-control-sm text-right fontred numberComma" name=carPrice2
                    id=carPrice2>
            </td>
        </tr>
        <tr class="">
            ...
            <!-- <td class=""></td> -->
            <td>
                <input type="text" class="form-control form-control-sm text-right fontred numberComma" name=carPrice3
                    id=carPrice3>
            </td>
        </tr>
    </tfoot>
