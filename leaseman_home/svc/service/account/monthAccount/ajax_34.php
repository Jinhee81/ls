...
$output .= "<td id='rightArea1'>".count($allRows)."</td>";
$output .= "<td id='rightArea2'>".$amountTotalArray[0]."</td>";
$output .= "<td id='rightArea3'>".$amountTotalArray[1]."</td>";
$output .= "<td id='rightArea4'>".$amountTotalArray[2]."</td>";
$output .= "</tr>";
