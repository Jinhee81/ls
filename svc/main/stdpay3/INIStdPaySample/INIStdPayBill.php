...
$price 			= "1100";        								// 상품가격(특수기호 제외, 가맹점에서 직접 설정)
...
/* 기타 */
$siteDomain = "http://".$_SERVER['HTTP_HOST']."/svc/main/stdpay3/INIStdPaySample"; //가맹점 도메인 입력
                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><b>returnUrl</b> :
                                                    <br/><input  style="width:100%;" name="returnUrl" value="<?php echo $siteDomain ?>/INIStdPayReturn_old.php" >
