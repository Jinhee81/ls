		...
		<div class="id_find" style="padding:20px; margin-top:30px; padding-bottom:0;">
			...
			<div class="mail_form"  style=" border:1px solid #bbbbbb;">
				<div class="mail_form_tit" style="text-align:center;">	
					<img src="http://leaseman.co.kr/img/sub/concuraition.png" style="vertical-align:middle; display:inline-block; margin-top:20px;">
					<b style="display:block; font-size:16px; font-weight:normal; color:#666666; margin-top:40px; line-height:22px;"> <span style="font-weight:normal;"><?php echo $user_name ?>님 임대관리전문시스템 리스맨에 회원가입하신 것을 환영합니다!
					<br />로그인하시면 더욱 많은 정보를 이용하실 수 있습니다.</b>
					<div class="button_box" style="display:table; margin:0 auto; margin-top:40px; overflow:hidden;">
						<b type="button" class="blue" style="width:220px; line-height:38px; float:left; height:38px; background:#2b506f;color:#fff;
						display:block; margin-bottom:40px;">
							<a href="http://leaseman.co.kr/membership/login.php" target="blank_" style="color:white; display:block; text-decoration:none;
							font-size:16px;" target="blank_">리스맨 프로그램 이용하기</a>
						</b>
						...
						width:120px; text-align:center; margin-bottom:40px;">
							<a href="http://www.leaseman.co.kr" style="color:#333333; display:block;text-decoration:none;
