...
<?php
		$siteDomain = "http://".$_SERVER['HTTP_HOST']."/svc/main/";

        echo $siteDomain;

        include_once($siteDomain.'http://www.leaseman.co.kr/svc/main/INIStdPayUtil.php');
        include_once($siteDomain.'http://www.leaseman.co.kr/svc/main/stdpay3/libs/HttpClient.php');
