...
?>
	...
	<section id="container">		
		<div class="layout_wrap">
			<div class="com_hbox">
				<h2 class="com_h2" data-type="게시판관리" data-title="FAQ">FAQ</h2>
			</div>
			<div class="com_btn_box">
				<div class="right">
					<button type="button" class="blue_btn" onClick="pops_02_1btn();">FAQ 추가</button>
				...
				<table class="ta_list01">
					...
					<tbody>
						<tr>	
							...
							<td>110</td>
							<td>기타문의</td>
							<td>결제 방법은 어떤것이 있나요?</td>
							<td></td>
							<td>2017-03-21 17:00</td>
							<td>2017-03-21 17:00</td>
							<td><a href="bmg_faq_mod.php">수정</a></td>
						</tr>
						<tr>
