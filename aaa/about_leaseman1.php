<!-- 이 파일이 원래 있던 파일, 여기에서 다운로드부분을 삭제해서 올림 -->
				...
				<div class="wrap_1000">
					<div class="main_down one">
						...
						<b class="down_btn">
							...
							alt="리스맨 어플 받으러 가기" target="blank_"><img src="../img/ico/google.png" alt="구글 플레이 이미지"></a>
						</b>
					</div>
					<div class="main_down two">
						...
						<b class="down_btn">
							<a href="http://sv.leaseman.co.kr/" target ="blank_"><img src="../img/ico/pc_vision.png">PC 버전 로그인</a>
						</b>
					</div>
				</div>
			</div> -->
