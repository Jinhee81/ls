...
<html lang="en" dir="ltr">
  <head>
    <title>리스맨 관리자</title>
    <link rel="icon" type="image/svg" href="/admin/inc/img/favicon.png">
    <meta charset="utf-8">
    ...
    <meta content='website' property='og:type'>
  	...
  	<meta content='회원가입 웹사이트입니다' property='og:description'>
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#04B431;">
      <a class="navbar-brand" href="/index.php"><img src="/admin/inc/img/leaseman_logo.png" width="100" height="30" class="d-inline-block align-top" alt=""></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <script src="/admin/inc/js/jquery-3.2.1.min.js"></script>
        <script src="/admin/inc/js/popper.min.js"></script>
        <script src="/admin/inc/js/bootstrap.min.js"></script>
        <script src="/admin/inc/js/mdb.min.js"></script>
      </div>
    </nav>
