...
?>
    ...
    <section class="container">
        <div class="jumbotron pt-3 pb-3">
            ...
            <p class="lead">
                ...
                (3) 직원이 있는 경우 부계정등록하여 사용하세요.
            </p>
            <hr class="my-4">
            <p>리스맨 회원가입후 30일동안 무료이용 가능합니다. 30일 이후 요금은 <a href="../../main/payment.php"
                    class="badge badge-warning">요금안내</a> 페이지를 참조하세요.<br>
            ...
            <a class="btn btn-primary btn-lg mr-1" href="account_add.php" role="button">부계정등록</a>
            <!-- <a class="btn btn-outline-primary btn-lg" href="account.php" role="button">계정추가</a> -->
        </div>
    </section>

    <section>
        <div class="container" name=building>
            <?php
    ...
    if($b_count < 1) {
      ...
      include "building_table.php";
        ...
        <div class="container mt-3 mb-5" name=account>
            <table class="table table-bordered">
                <tr class="bg-dark">
                    <th class="text-light text-center" colspan=6>부계정목록</th>
                </tr>
                ...
                <tr class="">
                    <td class="text-center" colspan=6>등록된 부계정이 없습니다. 직원이 있다면 부계정을 등록해서 사용하세요!</td>
                </tr>
            </table>
        </div>
    </section>
