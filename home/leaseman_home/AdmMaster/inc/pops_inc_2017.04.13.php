								...
								<tr>
									...
									<td>
										<div class="check_list">
											<span><input type="checkbox" id="" name="" /> <label for="">회원관리</label></span>
											<span><input type="checkbox" id="" name="" /> <label for="">데이터관리</label></span>
											<span><input type="checkbox" id="" name="" /> <label for="">게시판관리</label></span>
											<span><input type="checkbox" id="" name="" /> <label for="">정산관리</label></span>
											<span><input type="checkbox" id="" name="" /> <label for="">환경설정</label></span>
										</div>
									</td>
								</tr>
							</tbody>
						...
						<table class="ta_write01">
							...
							<tbody>
								...
								<tr>
									<th>URL</th>
									<td>
										<input type="text" id="" name="" value="" class="wd_full inpu_link" />
									</td>
								</tr>
								<tr>
									<th>발송대상</th>
						...
						<table class="ta_write01">
							...
							<tbody>
								...
								<tr>
									...
									<th>건물수</th>
									<td><input type="text"id="" name="" value="1개"  /></td>
								</tr>
								<tr>
									<th>일반전화</th>
									<td><input type="text"id="" name="" value="00-0000-0000"  /></td>
									<th>아이디수</th>
									<td><input type="text"id="" name="" value="1개"  /></td>
								</tr>
								<tr>
									<th>휴대폰</th>
									<td><input type="text"id="" name="" value="000-000-0000"  /></td>
									<th>이메일</th>
									<td><input type="text"id="" name="" value=""  /></td>
								</tr>
							</tbody>
