<?php
	...
	$total_sql = " 
					select c.user_id, c.user_code, c.user_name, c.r_date, b.house_type, b.aliasName, b.zipcode, b.addr, (select count(*) from tbl_room where b_idx = b.idx) as r_cnt, b.pay_type, b.security
					  from tbl_build b
			...
			<div class="com_search_box">
				<form action="" method="get" >
					<fieldset>
						...
						<button type="submit" class="lookup_btn">검색</button>
					</fieldset>
				</form>
			</div>
				...
				<table class="ta_list01">
					...
					?>
						...
						<tr>
							...
							<td><?=$row['zipcode']?></td>
							<td><?=$row['addr']?></td>
							<td><?=number_format($row['r_cnt'])?>개</td>
